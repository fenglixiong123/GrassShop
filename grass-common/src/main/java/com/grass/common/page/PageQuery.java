...
public class PageQuery<V> {
    ...
    public PageQuery(Integer page, Integer pageSize,String order,String orderDesc) {
        this.page = page;
        this.pageSize = pageSize;
        this.order = order;
    ...
    public PageQuery(Integer page, Integer pageSize,String order,String orderDesc,V entity) {
        this.page = page;
        this.pageSize = pageSize;
        this.order = order;
        this.orderDesc = orderDesc;
